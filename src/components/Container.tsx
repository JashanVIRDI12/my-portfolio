  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://www.jashanvirdi.codes${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://www.jashanvirdi.codes${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Jashan" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="Jashan" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">Jashan</span>
        </Link>
              ...
              <div className="flex h-full flex-col items-start justify-between overflow-y-auto">
                ...
                <div className="flex min-h-fit w-full flex-col space-y-8 px-[22px] py-10">
                  <span className="text-sm text-muted-foreground">
                    © {new Date().getFullYear()} Jashan. All rights reserved.
                  </span>
                </div>
              </div>
            </motion.div>
